# This script is a copy of mtl_patients.py file with only change applied is commenting below four lab measurement features for ablation study. 
# bicarbonate, fraction inspired oxygen, glascow coma scale total & platelets
